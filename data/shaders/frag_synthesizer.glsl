...
uniform float u_percent;  //default is 0
...
void main()
{
	...
	lowp vec4 gradientSample = texture2D(u_gradient, vec2(u_percent, 0.5));

	gl_FragColor = textureSample * gradientSample * clipping;
}
